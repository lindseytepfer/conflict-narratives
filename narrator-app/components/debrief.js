...
export const Debrief = ( { pageEvent } ) => {
    ...
    return(
        <div className="consent-form">
            ...
            <div>
                <p><strong>PLEASE CLICK THE BUTTON BELOW TO BE REDIRECTED TO YOUR CLOUD RESEARCH COMPLETION CODE:</strong></p>
                <button className="advance-button">ACCESS MY COMPLETION CODE</button>
            </div>
        </div>
    );
};